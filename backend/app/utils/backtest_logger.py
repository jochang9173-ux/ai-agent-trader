...
class BacktestLogger:
    ...
    def __init__(self, db_path: str = "backend/data/backtest_logs.db", session_id: str = None):
        """
    ...
    def log_daily_analysis(
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            """, (
                ...
                json.dumps(comprehensive_technical_analysis) if comprehensive_technical_analysis else None,
    ...
    def update_actual_results(self, log_id: int, actual_pnl: float, prediction_accuracy: float):
        """
        更新實際結果
    ...
    def query_logs(
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            for row in rows:
                ...
                # 解析JSON字段
                for json_field in ['trend_analysis', 'comprehensive_technical_analysis', 'triggered_events', 'llm_decision', 
                                  'trading_signal', 'strategy_state']:
